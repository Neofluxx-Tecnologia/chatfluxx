(function () {
  ...
  const FEATURES = [
    ...
    { id: 'conversor_contatos', label: 'Conversor de Contatos',  type: 'modal',  adminOnly: true,  url: 'https://neofluxx-tecnologia.github.io/chatfluxx/neofluxx-importer.html' },
  ...
  async function fetchPermissions() {
    ...
    try {
      const res = await fetch(
        SUPABASE_URL + '/rest/v1/vw_tenants_permissoes?tenant_key=eq.' + tenantKey + '&select=*&limit=1',
        {
          headers: {
            'apikey': SUPABASE_KEY,
